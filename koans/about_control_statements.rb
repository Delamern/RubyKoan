...
class AboutControlStatements < Neo::Koan
  ...
  def test_if_statements_return_values
    ...
    # just if statements.
    # Truthy Falsey https://learn.co/lessons/truthiness-in-ruby-readme
  end
  ...
  def test_next_statement
    ...
    while i < 10
      i += 1
      next if (i % 2) == 0
      result << i # << means add the item to the end of. For arrays, to end of array. For strings, will concatenate
    end
